...
BEGIN
	ALTER TABLE Silver.MedicalStock ADD CONSTRAINT FK_MedicalStock_Supplier FOREIGN KEY (supplier_id) REFERENCES Silver.Supplier (supplier_id);
...
BEGIN
	CREATE TABLE Silver.medicine_patient (
		...
		,Quantity INT
		,purchase_date DATE FOREIGN KEY (patient_id) REFERENCES Silver.Patient(patient_id)
		);
END
