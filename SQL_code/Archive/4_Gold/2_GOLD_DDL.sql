...
CREATE OR ALTER PROCEDURE Gold.create_ddl_gold AS
BEGIN
...
CREATE TABLE GOLD.Dim_Bed (
    ...
    room_skey INT, -- 🔑 Define this column before using it in a FK constraint
...
ADD 
    ...
    email VARCHAR(255),
    phone VARCHAR(20);
ALTER TABLE GOLD.Fact_Billing
ADD other_charges DECIMAL(10,2);
